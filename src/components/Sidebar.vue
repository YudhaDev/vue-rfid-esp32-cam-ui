<template>
    <aside :class="{ 'collapsed-navbar': storeToggle.pinia_collapsed_sidebar }">
        ...
        <div class="exclude">
            <Router-link to="/">
                <h1 class="text-4xl " :class="storeToggle.pinia_collapsed_sidebar ? 'my-nav-collapsed' : 'my-nav-expanded'">
                    {{ storeToggle.pinia_collapsed_sidebar ? 'R' : 'RFID' }}</h1>
            </Router-link>
            <Router-link to="/">
                <h1 class="text-4xl " :class="storeToggle.pinia_collapsed_sidebar ? 'my-nav-collapsed' : 'my-nav-expanded'">
                    {{ storeToggle.pinia_collapsed_sidebar ? 'H' : 'Helm' }}</h1>
            </Router-link>
            <Router-link to="/">
                <h1 class="text-4xl " :class="storeToggle.pinia_collapsed_sidebar ? 'my-nav-collapsed' : 'my-nav-expanded'">
                    {{ storeToggle.pinia_collapsed_sidebar ? 'D' : 'Detection' }}</h1>
            </Router-link>
        </div>
        <div class="vertical-linear">
            <RouterLink class="rounded-xl" to="/scan">
                <div class="nav-item-wrapper">
                    ...
                    <p>{{ storeToggle.pinia_collapsed_sidebar ? '' : 'Scan Masuk' }}</p>
                </div>
            </RouterLink>
            <RouterLink class="rounded-xl" to="/scan-pulang">
                <div class="nav-item-wrapper">
                    <span class="material-icons flex-item">barcode_reader</span>
            ...
            <RouterLink class="rounded-xl" to="/kehadiran-view">
                <div class="nav-item-wrapper">
                    ...
                    <p>{{ storeToggle.pinia_collapsed_sidebar ? '' : 'Tabel Kehadiran' }}</p>
                </div>
            </RouterLink>
